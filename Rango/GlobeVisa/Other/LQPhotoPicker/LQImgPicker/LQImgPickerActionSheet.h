...
@interface LQImgPickerActionSheet : NSObject<UIImagePickerControllerDelegate,UINavigationControllerDelegate, UIActionSheetDelegate,MShowAllGroupDelegate,DJCameraViewControllerDeletate>
{
...
@property (nonatomic, assign) NSInteger selectIndex;//修改时候点击的位置
@property (nonatomic, strong) NSMutableArray *selectArr;    // 存储图片留
