...
@property (nonatomic, assign) NSInteger maxSelectNum; // 多选选择的最大数目
@property (nonatomic, strong) NSMutableArray *selectDayView; //选中的视图

@property (nonatomic, assign) NSInteger startDay;     // 几天 之内 不可选择
@property (nonatomic, copy) NSString  *endDay;       //   @"2017-9-12"  几天 之后 不可选择
